...
faireComb($lstObjOffre[0], $etudiantNull, $combsOffre, $lstCombSemaineSupp);

print '<h2 class=combValide> Combinaisons retenues de la semaine</h2> <br>';
...
if (count($lstCombSemaineSupp) > 0) {
    print '<h2 class=combInvalide> Combinaisons non retenues de la semaine</h2> ';
