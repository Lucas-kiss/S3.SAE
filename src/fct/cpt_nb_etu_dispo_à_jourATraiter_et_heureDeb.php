 ...
 * @brief   Fonction appelé dans la fonction calculerCombJour()
 ...
 * @param $jourATraiter objet de type Jour correspondant à un jour de la semaine où on chercher à calculer toute les combinaisons du jour
